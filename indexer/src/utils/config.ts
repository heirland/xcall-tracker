const { PK_BERLIN, PK_SEPOLIA } = {
  PK_BERLIN: 'e7992a7a6884800c19ea9055fac44faf1806f63beba4047980d4fe8df84eaa16',
  PK_SEPOLIA:
    '0xba5bb3d42d7ec1902d0f6993b681c16001aff54b47fafc2006359b4b73068681',
};
...
export const configs = {
  ...
  BMC_SECONDARY: config.contract[NETWORK_SECONDARY].bmc,
  NETWORK_LABEL_BERLIN: config.network[NETWORK_PRIMARY].label,
  NETWORK_LABEL_SEPOLIA: config.network[NETWORK_SECONDARY].label,
